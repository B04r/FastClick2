...
export default class FastClick extends Component {
  constructor(props) {
    super(props);
    this.state = {
      imeIgre: "Fast Clik",
        ...
        <div className="brziKlikOuterDiv">
          ...
          <div className="brziKlikInnerDiv">
            <div className="brziKlikText">
              ...
              <p>
                {this.props.username} - broj klikova: {this.state.score}
              </p>
            </div>
            <button
              type="button"
